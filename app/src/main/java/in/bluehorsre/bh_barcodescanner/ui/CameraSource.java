 ...
 * {@link in.bluehorsre.bh_barcodescanner.ui.CameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSource {
     ...
     * See {@link com.google.android.gms.vision.Frame.Metadata#getRotation()}.
     */
     ...
     * android.hardware.Camera.Parameters#FOCUS_MODE_CONTINUOUS_VIDEO} and {@link
     * android.hardware.Camera.Parameters#FOCUS_MODE_CONTINUOUS_PICTURE}. Applications can show
     ...
     *
     * @throws java.io.IOException if the camera's preview texture or display could not be initialized
     */
     ...
     * @throws java.io.IOException if the supplied surface holder could not be used as the preview display
     */
    @RequiresPermission(Manifest.permission.CAMERA)
     ...
     * {@link #start(android.view.SurfaceHolder)}.
     * <p/>
     ...
     * activated previously with {@link #start()} or {@link #start(android.view.SurfaceHolder)}.  The camera
     ...
     * #autoFocus(in.bluehorsre.bh_barcodescanner.ui.CameraSource.AutoFocusCallback)} to start the focus if focus
     ...
     * (between {@link #start()} or {@link #start(android.view.SurfaceHolder)} and before {@link #stop()} or {@link #release()}).
     * <p/>
     * <p>Callers should check
     * {@link #getFocusMode()} to determine if
     * this method should be called. If the camera does not support auto-focus,
     * it is a no-op and {@link in.bluehorsre.bh_barcodescanner.ui.CameraSource.AutoFocusCallback#onAutoFocus(boolean)}
     ...
     *
     * @see #autoFocus(in.bluehorsre.bh_barcodescanner.ui.CameraSource.AutoFocusCallback)
     */
